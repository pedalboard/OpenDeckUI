      ...
      <div class="footer-container">
        <div class="footer-info">
          <div class="social-icons">
            <ul class="icons">
              <li>
                <a
                  href="https://github.com/pedalboard"
                  target="_blank"
                  rel="noopener"
                  aria-label="GitHub"
                >
        ...
        <div class="footer-copyright">
          <div class="footer-text">
            <p>Pedalboard &copy; 2026</p>
            <p>Based on <a href="https://github.com/shanteacontrols/OpenDeckUI" target="_blank">OpenDeck</a> by Shantea Controls</p>
          </div>
        </div>
      </div>
    </footer>
